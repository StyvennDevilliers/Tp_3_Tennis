    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            for (int i = 0; i < nbrvictoire; i++) {
                ...
                nbrpointstot += nbrpoints + nbrpointsvictoire;
                System.out.println("Nombre de points gagnée: " + nbrpointsvictoire);
                System.out.println("Nombre de points après la victoire: " + nbrpointstot);

            }

            if (nbrpointstot >= 660 && classement == _15_5) {
                nvclassement = _15_4;
                monte = true;
            } else if (nbrpointstot >= 580 && classement == _30) {
                nvclassement = _15_5;
                monte = true;
            } else if (nbrpointstot >= 510 && classement == _30_1) {
                nvclassement = _30;
                monte = true;
            } else if (nbrpointstot >= 480 && classement == _30_2) {
                nvclassement = _30_1;
                monte = true;
            } else if (nbrpointstot >= 410 && classement == _30_3) {
                nvclassement = _30_2;
                monte = true;
            } else if (nbrpointstot >= 340 && classement == _30_4) {
                nvclassement = _30_3;
                monte = true;
            } else if (nbrpointstot >= 260 && classement == _30_5) {
                nvclassement = _30_4;
                monte = true;
            } else if (nbrpointstot >= 150 && classement == _40) {
                nvclassement = _30_5;
                monte = true;
            } else if (nbrpointstot >= 80 && classement == NC) {
                nvclassement = _40;
                monte = true;
            } else {
            ...
            if (!monte) {
                if (nbrpointstot < 395 && classement == _15_4) {
                    nvclassement = _15_5;
                } else if (nbrpointstot < 325 && classement == _15_5) {
                    nvclassement = _30;
                } else if (nbrpointstot < 290 && classement == _30) {
                    nvclassement = _30_1;
                } else if (nbrpointstot < 245 && classement == _30_1) {
                    nvclassement = _30_2;
                } else if (nbrpointstot < 205 && classement == _30_2) {
                    nvclassement = _30_3;
                } else if (nbrpointstot < 145 && classement == _30_3) {
                    nvclassement = _30_4;
                } else if (nbrpointstot < 90 && classement == _30_4) {
                    nvclassement = _30_5;
                } else if (nbrpointstot < 50 && classement == _30_5) {
                    nvclassement = _40;
                } else {
                    nvclassement = classement;
                }
